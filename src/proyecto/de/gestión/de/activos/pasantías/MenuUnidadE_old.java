 ...
 * @author JUNIORCEDE
 */
public class MenuUnidadE_old extends javax.swing.JFrame {

    /**
     * Creates new form MainMenu
     */
    public MenuUnidadE_old() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuUnidadE_old.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuUnidadE_old().setVisible(true);
            }
        });
    }
